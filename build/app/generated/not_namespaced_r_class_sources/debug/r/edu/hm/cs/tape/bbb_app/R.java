...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #Capability_queryPatterns edu.hm.cs.tape.bbb_app:queryPatterns}</code></td><td>Resource reference to the string array of query patterns for a custom capability.</td></tr>
     * <tr><td><code>{@link #Capability_shortcutMatchRequired edu.hm.cs.tape.bbb_app:shortcutMatchRequired}</code></td><td>Indicates whether a parameter in a capability template can only contain a matched
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:queryPatterns
     */
     ...
     * "<code>false</code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:shortcutMatchRequired
     */
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha edu.hm.cs.tape.bbb_app:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority edu.hm.cs.tape.bbb_app:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts edu.hm.cs.tape.bbb_app:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy edu.hm.cs.tape.bbb_app:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout edu.hm.cs.tape.bbb_app:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage edu.hm.cs.tape.bbb_app:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery edu.hm.cs.tape.bbb_app:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderSystemFontFamily edu.hm.cs.tape.bbb_app:fontProviderSystemFontFamily}</code></td><td>Provides the system font family name to check before downloading the font.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderQuery
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontProviderSystemFontFamily
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font edu.hm.cs.tape.bbb_app:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle edu.hm.cs.tape.bbb_app:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings edu.hm.cs.tape.bbb_app:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight edu.hm.cs.tape.bbb_app:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex edu.hm.cs.tape.bbb_app:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:font
     */
     ...
     * </table>
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name edu.hm.cs.tape.bbb_app:ttcIndex
     */
